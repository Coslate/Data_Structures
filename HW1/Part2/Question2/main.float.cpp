...
//        std::cerr<<e.what()<<std::endl;
//    }
    try{test_sparse_matrix_a_add_b_result = test_sparse_matrix_a.Add(test_sparse_matrix_b);}
    catch(std::runtime_error &e){
        std::cerr<<e.what()<<std::endl;
    }
    ...
    try{test_sparse_matrix_a_mul_b_result = test_sparse_matrix_a.Multiply(test_sparse_matrix_b);}
    catch(std::runtime_error &e){
        std::cerr<<e.what()<<std::endl;
    }
    try{std::cout<<"test_sparse_matrix_a * test_sparse_matrix_b = "<<test_sparse_matrix_a_mul_b_result<<std::endl;}
    catch(std::runtime_error &e){
        std::cerr<<e.what()<<std::endl;
    }
